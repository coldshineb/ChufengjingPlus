 ...
 *
 *    Keep the ElementsChufengjingPlusMod object in this class and all calls to this object
...
public class ChufengjingPlusMod {
	...
	public ElementsChufengjingPlusMod elements = new ElementsChufengjingPlusMod();
	@Mod.EventHandler
	public void preInit(FMLPreInitializationEvent event) {
		MinecraftForge.EVENT_BUS.register(this);
		GameRegistry.registerWorldGenerator(elements, 5);
		GameRegistry.registerFuelHandler(elements);
		NetworkRegistry.INSTANCE.registerGuiHandler(this, new ElementsChufengjingPlusMod.GuiHandler());
